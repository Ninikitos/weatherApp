import { ui, TransformNode, ModelNode, ImmersiveApp } from 'lumin';
...
class PlatformFactory extends NativeFactory {
  ...
  _removeChildNodeToParentNode (parent, child) {
    ...
    } else if (parent instanceof ui.UiListView) ; else if (parent instanceof ui.UiSlider) ; else if (parent instanceof ui.UiRectLayout) ; else if (parent instanceof ui.UiDropDownList) ; else if (parent instanceof ui.UiDialog) ; else if (parent instanceof ui.UiToggle) ; else if (parent instanceof ui.UiPanel) ; else if (parent instanceof ui.UiPortalIcon) ; else if (parent instanceof ui.UiPageView) {
      if (child instanceof TransformNode) {
