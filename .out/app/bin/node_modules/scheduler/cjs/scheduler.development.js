...
function flushWork(hasTimeRemaining, initialTime) {
  ...
  try {
    if (!hasTimeRemaining) {
      ...
      // a boolean argument?
      while (firstTask !== null && firstTask.expirationTime <= currentTime && !(enableSchedulerDebugging)) {
      ...
      if (firstTask !== null) {
        do {
          ...
          currentTime = exports.unstable_now();
          advanceTimers(currentTime);
        } while (firstTask !== null && !shouldYieldToHost() && !(enableSchedulerDebugging));
      }
    }
...
export { scheduler_development as __moduleExports, scheduler_development_6 as unstable_IdlePriority, scheduler_development_3 as unstable_ImmediatePriority, scheduler_development_7 as unstable_LowPriority, scheduler_development_5 as unstable_NormalPriority, scheduler_development_4 as unstable_UserBlockingPriority, scheduler_development_11 as unstable_cancelCallback, scheduler_development_16 as unstable_continueExecution, scheduler_development_2 as unstable_forceFrameRate, scheduler_development_13 as unstable_getCurrentPriorityLevel, scheduler_development_18 as unstable_getFirstCallbackNode, scheduler_development_9 as unstable_next, scheduler_development_1 as unstable_now, scheduler_development_17 as unstable_pauseExecution, scheduler_development_15 as unstable_requestPaint, scheduler_development_8 as unstable_runWithPriority, scheduler_development_10 as unstable_scheduleCallback, scheduler_development_14 as unstable_shouldYield, scheduler_development_12 as unstable_wrapCallback };
